...
export const ERR_LIST_UNEXPECTED_COMMA = "unexpected comma"
export const ERR_LIST_EXPECTED_COMMA = "expected comma"
...
export const ERR_DIVISION_BY_ZERO = "division by zero"
export const ERR_MATH = "math error"